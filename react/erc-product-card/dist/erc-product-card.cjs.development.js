...
var useProduct = function useProduct(_ref) {
  var customOnChange = _ref.customOnChange,
      product = _ref.product,
      _ref$customValue = _ref.customValue,
      customValue = _ref$customValue === void 0 ? 0 : _ref$customValue,
      initialValues = _ref.initialValues;

  var _useState = React.useState((initialValues == null ? void 0 : initialValues.count) || customValue),
      counter = _useState[0],
  ...
  var reset = function reset() {
    setCounter((initialValues == null ? void 0 : initialValues.count) || customValue);
  };
...
//# sourceMappingURL=erc-product-card.cjs.development.js.map
